  ...
  const cards = [
    {
      ...
      svg: (
        <svg
          ...
          fill="none"
        >
          <g id="book-solid 1" clipPath="url(#clip0_2090_216)">
            <path
              id="Vector"
    ...
    },
    {
      ...
      svg: (
        <svg
          ...
          fill="none"
        >
          <g id="book-open-solid 2" clipPath="url(#clip0_2090_223)">
            <path
              id="Vector"
    ...
    },
    {
      ...
      svg: (
        <svg
          ...
          fill="none"
        >
          <g id="laptop-file-solid 1" clipPath="url(#clip0_2090_230)">
            <path
              id="Vector"
              ...
              fill="url(#paint0_linear_2090_230)"
            />
          </g>
          <defs>
            <linearGradient
              id="paint0_linear_2090_230"
              x1={0}
              y1={0}
              x2={69}
              y2={57}
