...
import 'home_page_detail_model.dart';
export 'home_page_detail_model.dart';
...
class _HomePageDetailWidgetState extends State<HomePageDetailWidget>
  ...
  late HomePageDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageDetailModel());
                                ...
                                children: [
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('paymentcompleted');
                                      },
                                      text: 'Pay now',
