...
const IconTele = ({ fill = "#000000", hoverFill = "#FF0000", className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      className={`w-6 h-6 md:w-10 md:h-10 ${className}`} // Menggunakan Tailwind untuk ukuran responsif
      viewBox="0 0 50 50"
